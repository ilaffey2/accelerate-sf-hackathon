...
const SuggestedPrompts: React.FC = () => {
    return (
        <div className="suggested-prompts grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-x-10 gap-y-4 p-4">
            {prompts.map((prompt) => (
                <button key={prompt.id} className="prompt bg-white rounded-lg shadow-md p-2 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">
